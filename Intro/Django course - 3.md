...
1. Learn static file handling of Django
2. Create CSS file, and also include image file, into the webapp
3. Learn ways of test in Django
4. Practice using shell to do test
5. Practice using Django testcase
